...
rm -R "/home/$USER/Downloads/Pixel9GRAPHENEOS/$VERSION/$DEVICE_NAME"
mkdir -p "/home/$USER/Downloads/Pixel9GRAPHENEOS/$VERSION/$DEVICE_NAME"
chmod 777 "/home/$USER/Downloads/Pixel9GRAPHENEOS/$VERSION/$DEVICE_NAME"
...
wget -P "/home/$USER/Downloads/Pixel9GRAPHENEOS/$VERSION/$DEVICE_NAME/" "https://releases.grapheneos.org/$DEVICE_NAME-install-$VERSION.zip.sig"
wget -P "/home/$USER/Downloads/Pixel9GRAPHENEOS/$VERSION/$DEVICE_NAME/" "https://releases.grapheneos.org/$DEVICE_NAME-ota_update-$VERSION.zip"


ssh-keygen -Y verify -f "/home/$USER/Downloads/Pixel9GRAPHENEOS/$VERSION/$DEVICE_NAME/allowed_signersGTH" -I contact@grapheneos.org -n "factory images" -s "/home/$USER/Downloads/Pixel9aGRAPHENEOS/$VERSION/$DEVICE_NAME/$DEVICE_NAME-install-$VERSION.zip.sig" < "/home/$USER/Downloads/Pixel9aGRAPHENEOS/$VERSION/$DEVICE_NAME/$DEVICE_NAME-install-$VERSION.zip"

curl -L --create-dirs -o "/home/$USER/Downloads/Pixel9GRAPHENEOS/platform-tools_r35.0.2-linux.zip" "https://dl.google.com/android/repository/platform-tools_r35.0.2-linux.zip"
echo "acfdcccb123a8718c46c46c059b2f621140194e5ec1ac9d81715be3d6ab6cd0a  /home/$USER/Downloads/Pixel9GRAPHENEOS/platform-tools_r35.0.2-linux.zip" | sha256sum -c

bsdtar xvf "/home/$USER/Downloads/Pixel9GRAPHENEOS/platform-tools_r35.0.2-linux.zip" -C "/home/$USER/Downloads/Pixel9aGRAPHENEOS/" 
#DO NOT TOUCH THE ABOVE: CORRECT PATH LINE!
sleep 60s;

export PATH="/home/$USER/Downloads/Pixel9GRAPHENEOS/platform-tools:$PATH"

if [ $(fastboot --version | grep -oP '(?<=fastboot version .{0}).{0,2}') -ge 35 ]; then 
echo "Adequate fastboot version installed in: /home/$USER/Downloads/Pixel9GRAPHENEOS/platform-tools/fastboot"
else
...
sleep 10s;
# unpack image zip
bsdtar xvf "/home/$USER/Downloads/Pixel9GRAPHENEOS/$VERSION/$DEVICE_NAME/$DEVICE_NAME-install-$VERSION.zip" -C "/home/$USER/Downloads/Pixel9aGRAPHENEOS/$VERSION/$DEVICE_NAME/" 
sleep 3s;

cd "/home/$USER/Downloads/Pixel9GRAPHENEOS/$VERSION/$DEVICE_NAME/$DEVICE_NAME-install-$VERSION/" && bash flash-all.sh
