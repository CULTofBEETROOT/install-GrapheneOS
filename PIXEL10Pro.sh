...
cmp -s "/home/$USER/Downloads/Pixel10ProGRAPHENEOS/$VERSION/$DEVICE_NAME/allowed_signersGTH" "/home/$USER/Downloads/Pixel9aGRAPHENEOS/$VERSION/$DEVICE_NAME/allowed_signersGOS" && echo "github GrapheneOS and GrapheneOS website, signers, are a match:)." || echo "The signature offered is not GrapheneOS's! STOP NOW!" 
sleep 3s;
